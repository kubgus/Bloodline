namespace BloodlineEngine
{
    public static class Collision
    {
        ...
        public static Vector2[] GetPolygonAxes(Vector2[] shapeA, Vector2[] shapeB)
        {
        ...
        public static void AddUniqueAxes(Vector2[] shape, List<Vector2> axes)
        {
        ...
        public static bool IsSeparatingAxis(Vector2[] shapeA, Vector2[] shapeB, Vector2 axis)
        {
        ...
        public static Projection GetProjection(Vector2[] shape, Vector2 axis)
        {
